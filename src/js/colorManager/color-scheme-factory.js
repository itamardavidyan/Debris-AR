...
class ColorSchemeFactory {
  ...
  static resetObjectTypeFlags() {
    ColorSchemeFactory.objectTypeFlags.payload = false;
    ColorSchemeFactory.objectTypeFlags.radarData = false;
    ColorSchemeFactory.objectTypeFlags.rocketBody = true;
    ColorSchemeFactory.objectTypeFlags.debris = true;
    ColorSchemeFactory.objectTypeFlags.facility = false;
    ColorSchemeFactory.objectTypeFlags.sensor = false;
    ColorSchemeFactory.objectTypeFlags.missile = false;
    ColorSchemeFactory.objectTypeFlags.missileInview = false;
    ColorSchemeFactory.objectTypeFlags.trusat = false;
    ColorSchemeFactory.objectTypeFlags.inFOV = false;
    ColorSchemeFactory.objectTypeFlags.inviewAlt = false;
    ColorSchemeFactory.objectTypeFlags.starLow = false;
    ColorSchemeFactory.objectTypeFlags.starMed = false;
    ColorSchemeFactory.objectTypeFlags.starHi = false;
    ColorSchemeFactory.objectTypeFlags.satLEO = false;
    ColorSchemeFactory.objectTypeFlags.satGEO = false;
    ColorSchemeFactory.objectTypeFlags.satLow = false;
    ColorSchemeFactory.objectTypeFlags.satMed = false;
    ColorSchemeFactory.objectTypeFlags.satHi = false;
    ColorSchemeFactory.objectTypeFlags.satSmall = false;
    ColorSchemeFactory.objectTypeFlags.rcsSmall = false;
    ColorSchemeFactory.objectTypeFlags.rcsMed = false;
    ColorSchemeFactory.objectTypeFlags.rcsLarge = false;
    ColorSchemeFactory.objectTypeFlags.rcsUnknown = false;
    ColorSchemeFactory.objectTypeFlags.velocitySlow = false;
    ColorSchemeFactory.objectTypeFlags.velocityMed = false;
    ColorSchemeFactory.objectTypeFlags.velocityFast = false;
    ColorSchemeFactory.objectTypeFlags.ageNew = false;
    ColorSchemeFactory.objectTypeFlags.ageMed = false;
    ColorSchemeFactory.objectTypeFlags.ageOld = false;
    ColorSchemeFactory.objectTypeFlags.ageLost = false;
  }
