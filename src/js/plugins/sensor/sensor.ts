  ...
  keepTrackApi.register({
    ...
    cb: () => {
          ...
          <div id="customSensor-content" class="side-menu">
            <div class="row">
              ...
              <form id="customSensor">
                ...
                <div class="switch row tooltipped hide" data-position="right" data-delay="50" data-tooltip="Is this Sensor a Telescope?">
                  <label>
                ...
                <div class="center-align">
                  <button id="cs-submit" class="btn btn-ui waves-effect waves-light" type="submit" name="action">Update Sensor &#9658;</button>
                </div>
              </form>
            </div>
          </div>
      ...
      $('#customSensor').on('submit', function (e) {
        ...
        sensorManager.selectedSensor.lat = lat;
        sensorManager.selectedSensor.lon = lon;
        sensorManager.selectedSensor.alt = alt;
      ...
      setTimeout(() => {
        ...
        const lat = 31.4105931 // position.coords.latitude;
        const lon = 34.579884; // position.coords.longitude;
        sensorManager.selectedSensor.lat = lat;
        sensorManager.selectedSensor.lon = lon;
        sensorManager.selectedSensor.alt = 0;
