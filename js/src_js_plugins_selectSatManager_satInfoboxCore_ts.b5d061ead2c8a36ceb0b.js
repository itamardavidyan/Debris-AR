        ...
        cb: function (sat) {
            if (!satInfoboxCore.satMissionData.isLoaded) {
                ...
                $('#firebase-form').on('submit', function (e) {
                    ...
                    if (claim)
                        data['claim'] = claim;
                    var currentDebris = _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_2__.keepTrackApi.firebase.find(function (_a) {
                        var id = _a.id;
                        return id === satId;
                    });
                    if (currentDebris) {
                        ...
                        _app_js_api_externalApi__WEBPACK_IMPORTED_MODULE_2__.keepTrackApi.firebase.push({ id: satId, claim: claim, note: note });
                    }
...
//# sourceMappingURL=src_js_plugins_selectSatManager_satInfoboxCore_ts.b5d061ead2c8a36ceb0b.js.map